...
referencesWithBranchLocalVariables branchLocalVariables (Elm.Syntax.Node.Node expressionRange expression) =
    -- IGNORE TCO
    case expression of
        Elm.Syntax.Expression.FunctionOrValue qualification unqualifiedName ->
            if List.isEmpty qualification && (branchLocalVariables |> Set.member unqualifiedName) then
                []
...
letDeclarationReferencesWithBranchLocalVariables branchLocalVariables letDeclaration =
    case letDeclaration of
